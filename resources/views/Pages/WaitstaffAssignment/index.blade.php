...
@section('content')
    ...
    <h3 class="page-title">
        <span class="page-title-icon bg-gradient-primary text-white me-2">
            <a type="link" href="{{ route('waitstaffAssignment.create') }}" style="color: #f4f4f4"><i
                    class=" mdi mdi-plus"></i></a>
        </span> Create Waitstaff Assignment
    </h3>
                                ...
                                @foreach ($assignments as $assignment)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                <a type="link"
                                                    href="{{ route('waitstaffAssignment.edit', $assignment->id) }}">
                                                    <i class=" mdi mdi-lead-pencil " style="margin-right: 5px;"></i>
                                                </a>
                                                <form action="{{ route('waitstaffAssignment.destroy', $assignment->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
