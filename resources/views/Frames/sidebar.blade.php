        ...
        <li class="sidebar-dropdown">
          ...
          <div class="sidebar-submenu">
            <ul>
              ...
              <li>
                <a href="project-dashboard.html">Project Management</a>
              </li>
              <li>
                <a href="sales-dashboard.html">Sales Admin</a>
              </li>
              <li>
                <a href="crm-dashboard.html">CRM Admin</a>
              </li>
              <li>
                <a href="ecommerce-dashboard.html">Ecommerce Admin</a>
              </li>
              <li>
                <a href="quick-dashboard.html">Quick Admin</a>
              </li>
              <li>
                <a href="smart-dashboard.html">Smart Admin</a>
              </li>
              <li>
                <a href="helpdesk-dashboard.html">Help Desk Admin</a>
              </li>
            </ul>
          </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ route('reservation.index') }}">Reservation</a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-product">
                <ul class="nav flex-column sub-menu">
                    ...
                    <li class="nav-item"> <a class="nav-link" href="{{ route('menuItem.index') }}">Menu Item</a>
                    </li>
                </ul>
            </div>
        </li>
        <li class="nav-item">
          ...
          <div class="collapse" id="order">
              <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{ route('orderItem.index') }}">OrderItem</a>
                  </li>
              </ul>
          </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-bs-toggle="collapse" href="#staff" aria-expanded="false"
            aria-controls="staff">
        ...
        <div class="collapse" id="staff">
            <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('waitstaff.index') }}">Staff</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ route('waitstaffAssignment.index') }}"> Assignment</a>
                </li>
            </ul>
        </div>
    </li>
    <li class="nav-item">
      <a class="nav-link" data-bs-toggle="collapse" href="#purchase" aria-expanded="false"
      ...
      <div class="collapse" id="purchase">
          <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="{{ route('supplyItem.index') }}"> Supply item</a>
              </li>
          </ul>
      </div>
  </li> --}}
